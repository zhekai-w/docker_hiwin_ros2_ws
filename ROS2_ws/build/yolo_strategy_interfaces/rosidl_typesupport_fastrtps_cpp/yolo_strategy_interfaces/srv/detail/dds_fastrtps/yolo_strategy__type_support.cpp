...
#include "yolo_strategy_interfaces/srv/detail/yolo_strategy__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.update_position;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: update_position
  {
    ...
    size_t item_size = sizeof(ros_message.update_position[0]);
...
{
  auto typed_message =
    static_cast<const yolo_strategy_interfaces::srv::YoloStrategy_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolo_strategy_interfaces::srv::YoloStrategy_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YoloStrategy_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yolo_strategy_interfaces::srv::YoloStrategy_Request *>(
...
static size_t _YoloStrategy_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YoloStrategy_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YoloStrategy_Request__callbacks = {
...
static rosidl_message_type_support_t _YoloStrategy_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YoloStrategy_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_yolo_strategy_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<yolo_strategy_interfaces::srv::YoloStrategy_Request>()
{
  return &yolo_strategy_interfaces::srv::typesupport_fastrtps_cpp::_YoloStrategy_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const yolo_strategy_interfaces::srv::YoloStrategy_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<yolo_strategy_interfaces::srv::YoloStrategy_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _YoloStrategy_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yolo_strategy_interfaces::srv::YoloStrategy_Response *>(
...
static size_t _YoloStrategy_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_YoloStrategy_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _YoloStrategy_Response__callbacks = {
  "yolo_strategy_interfaces::srv",
...
static rosidl_message_type_support_t _YoloStrategy_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YoloStrategy_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &yolo_strategy_interfaces::srv::typesupport_fastrtps_cpp::_YoloStrategy_Response__handle;
}
...
static service_type_support_callbacks_t _YoloStrategy__callbacks = {
  "yolo_strategy_interfaces::srv",
  "YoloStrategy",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_strategy_interfaces, srv, YoloStrategy_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolo_strategy_interfaces, srv, YoloStrategy_Response)(),
...
static rosidl_service_type_support_t _YoloStrategy__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_YoloStrategy__callbacks,
...
{
  return &yolo_strategy_interfaces::srv::typesupport_fastrtps_cpp::_YoloStrategy__handle;
}
