...
static rosidl_typesupport_introspection_c__MessageMember hiwin_interfaces__srv__RobotCommand_Request__rosidl_typesupport_introspection_c__RobotCommand_Request_message_member_array[15] = {
  {
    "holding",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hiwin_interfaces, srv, RobotCommand_Request)() {
  hiwin_interfaces__srv__RobotCommand_Request__rosidl_typesupport_introspection_c__RobotCommand_Request_message_member_array[9].members_ =
...
static rosidl_typesupport_introspection_c__MessageMember hiwin_interfaces__srv__RobotCommand_Response__rosidl_typesupport_introspection_c__RobotCommand_Response_message_member_array[2] = {
  {
    "arm_state",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_UINT8,  // type
    0,  // upper bound of string
