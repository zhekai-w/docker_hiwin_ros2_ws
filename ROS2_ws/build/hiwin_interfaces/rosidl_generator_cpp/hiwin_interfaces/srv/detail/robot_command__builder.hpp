...
public:
  ...
  : msg_(msg)
  {}
  Init_RobotCommand_Request_digital_output_pin base(::hiwin_interfaces::srv::RobotCommand_Request::_base_type arg)
  {
...
{
public:
  Init_RobotCommand_Request_holding()
...
{
  return hiwin_interfaces::srv::builder::Init_RobotCommand_Request_holding();
}
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_RobotCommand_Response_current_position arm_state(::hiwin_interfaces::srv::RobotCommand_Response::_arm_state_type arg)
  {
